    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="container">
                ...
                <form method="POST" action="airplaneController?operation=add" class="form-container" onsubmit="showResponse()">
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="name"><b>Nombre</b></label>
                            <input placeholder="Nombre" name="name" id="name" type="text" required>
                        </div>

                        <div class="col-lg-6">
                            <label for="places"><b>Plazas</b></label>
                            <input placeholder="Plazas" name="places" id="places" type="number" required>
                        </div>
                    </div>

                ...
                <form method="POST" action="userController" class="form-container" onsubmit="showResponse()">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <input placeholder="Dirección" name="addr" id="addr" type="text" required>
                        </div>
                        ...
                        <div class="col-lg-3">    
                            ...
                            <input placeholder="city" name="city" id="city" type="text" required pattern="[A-zÀ-ž\s]{1,}">
                        </div>

                        <div class="col-lg-3">
                            <label for="sname2"><b>País</b></label>
                            <input placeholder="country" name="country" id="country" type="text" required pattern="[A-zÀ-ž\s]{1,}">
                        </div>               
                    </div>
